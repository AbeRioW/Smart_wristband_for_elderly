...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MAX30102_SCL_Pin|MAX30102_SDA_Pin|BEEP_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : MAX30102_SCL_Pin MAX30102_SDA_Pin BEEP_Pin */
  GPIO_InitStruct.Pin = MAX30102_SCL_Pin|MAX30102_SDA_Pin|BEEP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
